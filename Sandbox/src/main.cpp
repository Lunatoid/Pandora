...
protected:
    ...
    virtual void OnImGui() override {
        ...
        if (ImGui::Begin("Cerberus")) {
            ImGui::DragFloat3("Position", cerberus.position.elements, 0.1f);
            ImGui::DragFloat3("Rotation", cerberus.rotation.elements, 0.1f);
            ImGui::DragFloat3("Scale", cerberus.scale.elements, 0.1f);
        }
        ImGui::End();

        if (ImGui::Begin("Plane")) {
            ImGui::DragFloat3("Position", plane.position.elements, 0.1f);
            ImGui::DragFloat3("Rotation", plane.rotation.elements, 0.1f);
            ImGui::DragFloat3("Scale", plane.scale.elements, 0.1f);
        }
        ImGui::End();
        ...
        if (ImGui::Begin("Game")) {
            ...
            window.SetImGuiEatInputs(!ImGui::IsWindowFocused());
