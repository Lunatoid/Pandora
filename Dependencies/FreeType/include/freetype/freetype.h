...
// MODIFICATION: This is a modification to
// avoid collision between the project and the library.
// The following line of code is not part of the FreeType library
#ifdef internal
#undef internal
#endif
