...
// Duplicate the utf8 string src by getting its size, malloc'ing a new memory
...
// place after the written codepoint. Pass how many bytes left in the memory to
