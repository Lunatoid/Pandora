#if !defined(PD_NO_IMGUI) && !defined(PD_NO_DIRECTX)
...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    //  1) Parse once, save the compiled shader blobs into a file or source code and pass them to CreateVertexShader()/CreatePixelShader() [preferred solution]
...
static void ImGui_ImplDX11_CreateWindow(ImGuiViewport* viewport)
{
    ...
    // DXGI_SWAP_EFFECT_DISCARD is deprecated, use double buffering
    // sd.BufferCount = 1;
    sd.BufferCount = 2;
    sd.OutputWindow = hwnd;
    sd.Windowed = TRUE;
    // DXGI_SWAP_EFFECT_DISCARD is deprecated, use DXGI_SWAP_EFFECT_FLIP_DISCARD
