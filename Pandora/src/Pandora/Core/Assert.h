...
#define PD_ASSERT(expr, fmt, ...) pd::Crash(expr, PD_FILENAME, PD_FUNCTION, PD_LINE,\
fmt, __VA_ARGS__);

// This asserts gets taken out on release
#if defined(PD_DEBUG)
#define PD_ASSERT_D PD_ASSERT
#else
...
void Crash(bool expr, const char* file, const char* function,
