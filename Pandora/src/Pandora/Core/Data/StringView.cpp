...
wchar* UTF8ToWide(const uchar* text, Allocator allocator) {
    int multiByteLength = MultiByteToWideChar(CP_UTF8, NULL, (char*)text, -1, NULL, 0);
    wchar* multiByte = (wchar*)Alloc(multiByteLength * sizeof(wchar), allocator);
    MultiByteToWideChar(CP_UTF8, NULL, (char*)text, -1, multiByte, multiByteLength);

    return multiByte;
}

wchar* UTF8ToWide(const uchar* text, int sizeInBytes, Allocator allocator) {
    int multiByteLength = MultiByteToWideChar(CP_UTF8, NULL, (char*)text, sizeInBytes, NULL, 0) + 1;
    wchar* multiByte = (wchar*)Alloc(multiByteLength * sizeof(wchar), allocator);
    MultiByteToWideChar(CP_UTF8, NULL, (char*)text, sizeInBytes, multiByte, multiByteLength);
...
uchar* WideToUTF8(const wchar* text, Allocator allocator) {
    int utf8Length = WideCharToMultiByte(CP_UTF8, NULL, text, -1, NULL, 0, NULL, NULL);
    uchar* utf8 = Alloc(utf8Length, allocator);
    WideCharToMultiByte(CP_UTF8, NULL, text, -1, (char*)utf8, utf8Length, NULL, NULL);

    return utf8;
}

uchar* WideToUTF8(const wchar* text, int size, Allocator allocator) {
    int utf8Length = WideCharToMultiByte(CP_UTF8, NULL, text, size, NULL, 0, NULL, NULL) + 1;
    uchar* utf8 = Alloc(utf8Length, allocator);
    WideCharToMultiByte(CP_UTF8, NULL, text, size, (char*)utf8, utf8Length, NULL, NULL);
